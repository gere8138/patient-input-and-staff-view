...
export default function NotFound() {
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center bg-paper px-6 text-center text-ink">
      ...
      <h1 className="mt-3 text-2xl font-semibold">That form link is not valid.</h1>
      <p className="mt-3 max-w-sm text-ink-soft">
        Session links look like <span className="font-mono">ABCD-2345</span>. Please start a new one.
      </p>
      <Link
        href="/"
